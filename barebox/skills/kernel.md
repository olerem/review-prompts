...
### Debugging
When asked to debug a barebox crash, oops, warning, or stack trace:
...
### Subsystem Context
When working on barebox code in specific subsystems, load the appropriate
...
- Both outputs are formatted for the Barebox mailing list (plain text, 78 char wrap)
