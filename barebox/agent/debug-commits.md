...
You search git history for commits related to a barebox bug in two
directions:

- **Backward**: Find the commit that introduced the bug
- **Forward**: Find existing fixes or related patches

You also search lore.barebox.org for relevant discussions.
...
Search lore.barebox.org for related discussions using lore_search with
