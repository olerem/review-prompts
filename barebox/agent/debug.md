...
description: Orchestrates barebox crash/bug debugging across multiple specialized agents
...
You coordinate the debugging of a barebox crash, oops, warning, or bug
...
- Barebox version and machine type if available
...
- every barebox function, type, and global symbol mentioned in the bug report
- Any additional barebox log messages
...
- Surface-level operations visible in the source text: what syscalls it
  ...
  these into barebox code -- that is the reproducer agent's job.
...
identify which barebox subsystems it exercises and generate theories
...
```json
{
  ...
  "crash": {
    ...
    "barebox_version": "string or null",
  ...
  "additional_messages": ["any other barebox log messages"]
}
```
