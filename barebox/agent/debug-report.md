...
description: Generates a plain-text debug report for the Barebox mailing list
...
barebox crash investigation. The report is formatted for the Barebox
mailing list and is meant to be consumed by barebox experts.
...
The report is plain text. It will be sent to the Barebox mailing
list.
...
2. Barebox version -- if available
...
5. Any other relevant barebox messages -- from bug.json
...
1. The report must be standalone. A barebox developer should understand
