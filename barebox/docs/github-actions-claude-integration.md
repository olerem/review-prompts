...
Claude officially supports GitHub-triggered code reviews through workflows. This document describes how to embed barebox review prompts into the [claude-code-action](https://github.com/anthropics/claude-code-action).
    ...
    steps:
      ...
      - name: Run Claude Code
        ...
        with:
          ...
          track_progress: true
          prompt: |
            Current directory is the root of a Barebox git repository.
