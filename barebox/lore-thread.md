# Lore Thread Analysis for Barebox Patch Reviews

## Purpose

Barebox patches are discussed on lore.barebox.org. Developers often fail to address
...
```
https://lore.barebox.org/bpf/<message-id>/
```
