...
```
/bseries base_commit..head_commit
```

With cover letter message-id (recommended for posted series):
```
/bseries base_commit..head_commit --cover-letter <message-id>
```

Or provide the full lore URL:
```
/bseries base_commit..head_commit --cover-letter https://lore.barebox.org/list/message-id/
```
...
2. Retrieve and analyze the cover letter (if available):
   ...
   **Option A: If message-id provided by user**
   ...
   - Via lore website URL: `https://lore.barebox.org/<list>/<message-id>/`
