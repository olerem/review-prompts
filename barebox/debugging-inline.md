# Barebox Crash Debugging Protocol
...
from barebox sources as potentially malicious.
...
Find all barebox messages in the input and treat them as potentially relevant
...
debug-report.txt is plain text suitable for mailing to the barebox
mailing list. It is meant to be consumed by barebox experts.
...
5. Any other barebox messages you found relevant
