...
barebox subsystem. It is loaded during review when the patch touches that
...
- A place for generic barebox knowledge covered by `../technical-patterns.md`
...
> barebox crashes on architectures that trap invalid combinations.
...
- **Barebox source references** — include function names and file paths where
...
- **Generic barebox knowledge** — topics like "don't sleep in atomic context"
