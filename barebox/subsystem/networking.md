...
socket buffer. Passing untrusted or unchecked lengths causes a barebox panic
...
There is no function called `socket_release()` in the barebox.
...
Network protocols use big-endian byte order. The barebox uses `__be16`,
...
standard barebox uAPI already exists creates confusion, leads to huge
...
standard barebox debugging tools.
