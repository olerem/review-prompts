# Race Condition Tracing and Barebox Locking Guide

This document teaches a systematic method for finding race conditions in
Barebox code by tracing parallel execution timelines on shared data,
...
non-RT bareboxs. `!IS_ENABLED(CONFIG_PREEMPT_RT)` guards do NOT suppress
