...
buffer, truncated strings, or barebox panics from buffer overflows. Misusing
...
The `page_fault_barebox` and `page_fault_user` tracepoints are declared
...
See `barebox/trace/rv/monitors/pagefault/Kconfig` for the actual example.
